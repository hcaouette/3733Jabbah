...
public class OpenTimeSlotsonDayTest {
	...
	public void testOpenTimeSlot() throws Exception{
		...
		OpenTimeSlotsonDay handler = new OpenTimeSlotsonDay();
		
		OpenTimeSlotsonDayRequest otsr = new OpenTimeSlotsonDayRequest("2018-12-19", "w" + rnd);
        ...
        Assert.assertEquals("Successfully opened all time slots on: 2018-12-19", resp.response);
	}
}
